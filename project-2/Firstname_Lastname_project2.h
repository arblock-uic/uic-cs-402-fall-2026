...
std::vector<std::string> merkle_open_position(const std::vector<std::string>& list, std::function<std::string(std::string)> hash_function, const unsigned int i);
int merkle_verify_position(const std::string root, const std::vector<std::string>& proof, std::function<std::string(std::string)> hash_function, const unsigned int i);
