...
int main() {
    ...
    //my_hybrid_sort(stable_int_test1);
    //my_hybrid_sort(stable_int_test2, true);
    ...
    //my_hybrid_sort(stable_char_test1);
    //my_hybrid_sort(stable_char_test2, true);
    ...
    //my_hybrid_sort(stable_string_test1);
    //my_hybrid_sort(stable_string_test2, true);
