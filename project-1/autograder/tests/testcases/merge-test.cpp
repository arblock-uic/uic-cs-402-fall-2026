...
int main() {
    ...
    merge_sort(stable_int_test1);
    merge_sort(stable_int_test2, true);
    ...
    merge_sort(stable_char_test1);
    merge_sort(stable_char_test2, true);
    ...
    merge_sort(stable_string_test1);
    merge_sort(stable_string_test2, true);
    ...
    // (unsigned) int different number tests; one point per pair (20 total)
    double asc_des_score = 0.0;
    unsigned int size_list[10] = {32, 64, 128, 256, 1024, 4098}; 
