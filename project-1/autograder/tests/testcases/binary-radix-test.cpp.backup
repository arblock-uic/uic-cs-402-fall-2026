...
int main() {
    ...
    // different type tests; 1 point each (4 points max)
    ...
    for(int i = 0; i < 5; ++i) {
        ...
        binary_radix_sort(ascending_test1);
        binary_radix_sort(ascending_test2);
        binary_radix_sort(descending_test1,true);
        binary_radix_sort(descending_test2,true);
